    ...
    <HashRouter>
      <Routes>
        ...
        {ExamplePageData.map((value: NavbarLinkProperty) => {
          return <Route key={"route.examples.section.page." + value.link} path={value.path} element={<ExamplesSectionPage exampleProps={value} {...PageData} />} />;
        })}
        {storybooks.map((value: NavbarLinkProperty) => {
          return <Route key={"route.examples.storybook.page." +value.link} path={value.path} element={<ExamplesStorybookPage exampleProps={value} {...PageData} />} />;
        })}
