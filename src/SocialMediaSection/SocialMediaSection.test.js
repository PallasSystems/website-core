...
test("Blank Social Media Credentials", () => {
    const result = render(React.createElement(SocialMediaSection, null));
...
test("All Social Media Credentials", () => {
    ...
    const result = render(React.createElement(SocialMediaSection, { ...socialProps }));
...
//# sourceMappingURL=SocialMediaSection.test.js.map