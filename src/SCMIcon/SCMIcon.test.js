...
test("Valid GitHub Credentials", () => {
    render(React.createElement(SCMIcon, { project: "proj", repository: "repo" }));
    const link = screen.getByRole("link");
    expect(link).toHaveAttribute('href', 'https://github.com/proj/repo');
});
test("Blank GitHub Credentials", () => {
    render(React.createElement(SCMIcon, { project: "", repository: "" }));
    const link = screen.getByRole("link");
    expect(link).toHaveAttribute('href', '');
});
test("Valid Alternative Credentials", () => {
    render(React.createElement(SCMIcon, { project: "proj", repository: "repo", endpoint: "https://bitbucket.org/" }));
    const link = screen.getByRole("link");
    expect(link).toHaveAttribute('href', 'https://bitbucket.org/proj/repo');
});
//# sourceMappingURL=SCMIcon.test.js.map