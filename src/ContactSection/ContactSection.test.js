...
test("Blank Footer", () => {
    const result = render(React.createElement(ContactSection, null));
...
test("Valid Non Address Components Footer", () => {
    ...
    const result = render(React.createElement(ContactSection, { ...contactProps }));
    expect(result.container).toBeValid();
...
test("Address Components Partial Footer", () => {
    ...
    const result = render(React.createElement(ContactSection, { address: addressProps }));
    expect(result.container).toBeValid();
...
//# sourceMappingURL=ContactSection.test.js.map